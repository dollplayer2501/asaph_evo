...
if( isset($_POST['login']) ) {
	...
	if( !empty($_POST['image']) ) {
		$status = $asaphPost->postImage( $_POST['image'], $_POST['referer'], $_POST['title'], $_POST['memo'], $_POST['tag'] );
	}
	if( !empty($_POST['url']) ) {
		$status = $asaphPost->postUrl( $_POST['url'], $_POST['title'], $_POST['memo'], $_POST['tag'] );
	}
